...
public static class Drawing
{
    public static List<Piece> Draw(v2 a, v2 b)
    {
        ...
        var filter = Piece.All.Where(_ => _.IsDense && _ != Game.Player);
        var result = CastLine(a, b, _ => filter.Any(p => p.Pos == _));
    ...
    public static List<Piece> CreateUI(v2 min, v2 max, bool thick = false)
    {
